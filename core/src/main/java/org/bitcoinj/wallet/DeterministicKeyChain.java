...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public static final ImmutableList<ChildNumber> ACCOUNT_ZERO_PATH = ImmutableList.of(new ChildNumber(88, true));
...
//    public static final ImmutableList<ChildNumber> BIP44_ACCOUNT_ZERO_PATH =
//            ImmutableList.of(new ChildNumber(88, true), ChildNumber.ZERO_HARDENED, new ChildNumber(1, true));
