...
public class WhiteCoinNetParams extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;

    public WhiteCoinNetParams() {
        super();
        interval = INTERVAL;
    ...
    private static WhiteCoinNetParams instance;
    public static synchronized WhiteCoinNetParams get() {
        if (instance == null) {
            instance = new WhiteCoinNetParams();
        }
        return instance;
    }
